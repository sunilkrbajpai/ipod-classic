        ...
        return (
            <div style={cssProp} className="information-container">
                <div className="info-div">
                    ...
                    <p>Github-Link : <a href="https://github.com/arnavdesk/iPod-Classic">iPod</a> 
                    </p>
                    <p>Hosting-Link : <a href="https://arnavdesk.github.io/iPod-Classic">iPod-Hosted</a> 
                    </p>
                    <p>App Developed by : <a href="https://github.com/arnavdesk">arnavdesk</a></p>
